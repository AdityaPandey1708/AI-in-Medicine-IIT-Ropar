...
class GeneSegModel(UnetModel):
    ...
    def eval(self, x, batch_size=8, channels=None, channel_axis=None, 
             ...
             flow_threshold=-1, confidence_threshold=-1,
             compute_masks=True, min_size=-1, stitch_threshold=0.0, progress=None,  
        ...
        if isinstance(x, list) or x.squeeze().ndim==5:
            ...
            for i in iterator:
                maski, flowi, stylei = self.eval(x[i], 
                                                                ...
                                                                resample=resample, 
                                                                interp=interp,
                                                                flow_threshold= -1 , #flow_threshold
            ...
            flows = [plot.dx_to_circ(offsetmap), offsetmap, plot.dx_to_circ(confimap), confimap]
            
            i=np.random.rand()
            plt.imsave(f'/Users/adityapandey/Documents/OData/Cases/masks/{i}.png', masks)
            plt.imsave(f'/Users/adityapandey/Documents/OData/Cases/confi/{i}.png', confimap)
