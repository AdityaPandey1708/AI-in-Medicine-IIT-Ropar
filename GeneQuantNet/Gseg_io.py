...
#         print('searching from folder',os.path.join(folder, "images"))
        raise ValueError('ERROR: no images in --dir folder','searching from folder',os.path.join(folder, "images"))
...
def load_train_test_data(train_dir, N, args, test_dir=None, image_filter='_image', mask_filter='_label', heatmap_filter='_gaumap_all', foldername = 'newlabels'):
    ...
    train_dir_list.remove('.DS_Store')
#     train_dir_list.remove('._.DS_Store')
...
def save_masks(images, masks, flows, label, spot, file_names, png=True, tif=False, foldername = 'newlabels', channels=[0,0],
    ...
    """
    i=np.random.rand()
    plt.imsave(f'/Users/adityapandey/Documents/OData/Cases/masks1/{i}.png', masks)
