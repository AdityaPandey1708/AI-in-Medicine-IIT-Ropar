...
class UnetModel():
    ...
    def eval(self, x, batch_size=8, channels=None, channels_last=False, invert=False, normalize=True,
             ...
             tile=True, cell_threshold=None, boundary_threshold=None, min_size=-1, 
             compute_masks=True):
        ...
        cell_threshold = -1 if cell_threshold is None else cell_threshold
        boundary_threshold = 0 if boundary_threshold is None else boundary_threshold
