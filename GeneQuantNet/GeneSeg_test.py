...
algorithm_args.add_argument('--flow_threshold', default=0, type=float, help='flow error threshold, 0 turns off this optional QC step. Default: %(default)s')
algorithm_args.add_argument('--confidence_threshold', default=-99999, type=float, help='cellprob threshold, default is 0, decrease to find more and larger masks')
